...
export const AboutUs = () => {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-paragraph">
        With over 10 years of experience in the industry, our team is dedicated
        to providing top-notch services tailored to meet your needs. From
        individual car transport to large-scale vehicle shipping, we specialize
        in handling every step of the process with care and professionalism.
      </p>

      <p className="about-us-paragraph">
        We pride ourselves on our commitment to on-time delivery, exceptional
